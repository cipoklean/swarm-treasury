...
contract TreasuryVaultTest is Test {
    ...
    function test_ExecuteProposal() public {
        // Create proposal targeting a simple external call that succeeds
        // Use a payable receive fallback so the low-level call doesn't revert
        vm.prank(yieldScout);
    ...
    function test_WithdrawFromStrategy() public {
        ...
        vm.prank(executor);
        vault.withdrawFromStrategy(address(strategy), 500 ether);
